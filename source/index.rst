...
The Py4Science is a bi-weekly, short, interactive series demonstrating the awesomeness of Python in
science. Those wishing to attend do not need to be expert at python programming, but familiarity with
...
15 python programs in 15 minutes
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
